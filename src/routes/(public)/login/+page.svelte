          ...
          <form class="flex flex-col justify-center p-6 md:p-8" onsubmit={onSubmit}>
            <FieldGroup>
              <div class="flex flex-col items-center gap-2 text-center">
                ...
                <p class="text-balance text-muted-foreground">Login to your Stripe account</p>
              </div>
              <Field>
                <FieldLabel for="email-{id}">Email</FieldLabel>
                <Input id="email-{id}" type="email" placeholder="john@uiu.ac.bd" required bind:value={email} />
              </Field>
              <Field>
