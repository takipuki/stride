<script>
  ...
  // 1. Import your newly built Editor component
  ...
  // 2. Create state to hold the editor's live HTML output
  let editorContent = $state(`int main() {
...
<div class="page-wrapper bg-background">
  <Resizable.PaneGroup direction="horizontal" class="h-full w-full overflow-hidden rounded-lg border">
    <Resizable.Pane defaultSize={50}>
      <Tiptap initialContent={editorContent} language="cpp" onUpdate={(html) => (editorContent = html)} />
    </Resizable.Pane>
            ...
            <Resizable.PaneGroup direction="vertical" class="h-full w-full">
              ...
              <Resizable.Pane defaultSize={85}>
                <Resizable.PaneGroup direction="horizontal" class="h-full w-full">
                  <Resizable.Pane defaultSize={50}>
                    <div class="flex h-full items-center justify-center p-6">
                      <span class="font-semibold text-zinc-500">Input</span>
                    </div>
                  </Resizable.Pane>
                  <Resizable.Handle />
                  <Resizable.Pane defaultSize={50}>
                    <div class="flex h-full items-center justify-center p-6">
                      <span class="font-semibold text-zinc-500">Output</span>
                    </div>
                  </Resizable.Pane>
                </Resizable.PaneGroup>
              </Resizable.Pane>
