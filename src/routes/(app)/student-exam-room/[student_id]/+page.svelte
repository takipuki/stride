...
<div class="page-wrapper">
  ...
  <Resizable.PaneGroup direction="horizontal" class="h-full w-full border rounded-lg">
  ...
  <div class="h-full w-full">
    ...
    <Resizable.PaneGroup direction="vertical" class="h-full w-full">
      ...
      <Resizable.Pane defaultSize={25} minSize={10} maxSize={30}>
        <div class="flex h-full items-center justify-center p-4 border-b">
          <span class="font-semibold"><ButtonGroup.Root class="flex flex-wrap gap-2">
