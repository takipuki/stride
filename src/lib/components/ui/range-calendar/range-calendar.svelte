...
<RangeCalendarPrimitive.Root
  ...
  class={cn(
    'group/calendar bg-background p-3 p-3 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(6)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent',
    className,
  )}
  {locale}
  {monthFormat}
