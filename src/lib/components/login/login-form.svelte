<script lang="ts">
  ...
  // All particles-related code has been removed.
</script>
...
<div class={cn('flex flex-col gap-6', className)} {...restProps}>
  <Card.Root class="overflow-hidden p-0">
    <Card.Content class="grid p-0 md:grid-cols-2">
      <form class="p-6 md:p-8">
        <FieldGroup>
          ...
          <Field>
            ...
            <Input id="email-{id}" type="email" placeholder="john@uiu.ac.bd" required />
          </Field>
          <Field>
     ...
     <div class="relative hidden md:flex items-center justify-center bg-black border-l select-none h-full w-full">
        <p class="text-7xl font-extrabold text-white">Stripe</p>
      </div>
    </Card.Content>
  </Card.Root>
